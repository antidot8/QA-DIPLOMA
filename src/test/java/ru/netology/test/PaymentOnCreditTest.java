...
import static ru.netology.data.DataHelper.twoNumbersCVVCardData;
...
//7.
    @Test
    void specialCharactersInCardholderPaymentByCardTest() {
        val startPage = new StartPage();
        val paymentByCardPage = startPage.selectPaymentByCardPage();
...
//8.
    @Test
    void numbersInCardholderPayment() {
        val startPage = new StartPage();
        val paymentByCardPage = startPage.selectPaymentByCardPage();
